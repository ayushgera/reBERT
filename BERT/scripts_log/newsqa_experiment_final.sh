...
python evaluate-reBERT.py data/newsqa/test_100.json experiment/192_32_0.0005_3_0.2_15_newsqa_validated_0_50/predictions.json experiment/192_32_0.0005_3_0.2_15_newsqa_validated_0_50/eval_result
...
python run_reBERT.py --bert_model experiment/bert-base-uncased-squad-newsqa-twice-model-v1.1 \
 --do_predict --do_lower_case --predict_file data/newsqa/test.json \
 --output_dir experiment/bert-base-uncased-squad-newsqa-twice-model-v1.1

python evaluate-reBERT.py data/newsqa/test.json experiment/bert-base-uncased-squad-newsqa-twice-model-v1.1/predictions.json experiment/bert-base-uncased-squad-newsqa-twice-model-v1.1/eval_result
...
# RUN NEWSQA SYNONYM 
python run_reBERT.py --bert_model experiment/bert-base-uncased-squad-model-v1.1/ \
--do_train \
--do_lower_case \
...
python run_reBERT.py --bert_model experiment/squad_newsqa_synonym_nmt_0.5 \
 --do_predict --do_lower_case --predict_file data/newsqa/test.json \
 --output_dir experiment/squad_newsqa_synonym_nmt_0.5

python evaluate-reBERT.py data/newsqa/test.json experiment/squad_newsqa_synonym_nmt_0.5/predictions.json experiment/squad_newsqa_synonym_nmt_0.5/eval_result
...
python run_reBERT.py --bert_model experiment/squad_synonym_0.5 \
 --do_predict --do_lower_case --predict_file data/newsqa/test.json \
 --output_dir experiment/squad_synonym_0.5

python evaluate-reBERT.py data/newsqa/test.json experiment/squad_synonym_0.5/predictions.json experiment/squad_synonym_0.5/eval_result
...
python run_reBERT.py --bert_model experiment/squad_synonym_0.5_2epoch \
 --do_predict --do_lower_case --predict_file data/newsqa/test.json \
 --output_dir experiment/squad_synonym_0.5_2epoch

python evaluate-reBERT.py data/newsqa/test.json experiment/squad_synonym_0.5_2epoch/predictions.json experiment/squad_synonym_0.5_2epoch/eval_result
...
python run_reBERT.py --bert_model experiment/squad_nmt_0.9 \
 --do_predict --do_lower_case --predict_file data/newsqa/test.json \
 --output_dir experiment/squad_nmt_0.9

python evaluate-reBERT.py data/newsqa/test.json experiment/squad_nmt_0.9/predictions.json experiment/squad_nmt_0.9/eval_result
